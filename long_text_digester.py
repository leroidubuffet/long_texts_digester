...
def send_large_text_to_chatgpt(file_path, prompt=None, model="chatgpt-4o-latest"):
    ...
    print("Encoding text data into tokens...")
    ...
    print("Decoding token chunks back to strings...")
    ...
    for i, chunk in enumerate(chunks):
        print(f"Sending part {i+1} to ChatGPT...")
...
if __name__ == "__main__":
    ...
    if prompt_text is None:
        print("Failed to read the prompt file.")
    else:
